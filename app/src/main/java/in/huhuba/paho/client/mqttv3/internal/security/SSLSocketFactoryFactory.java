 ...
 */
package in.huhuba.paho.client.mqttv3.internal.security;
...
import in.huhuba.paho.client.mqttv3.MqttSecurityException;
...
public class SSLSocketFactoryFactory {
	...
	private static final String TAG = LogUtils.makeLogTag(SSLSocketFactoryFactory.class);
...
//		}
	...
	private SSLContext getSSLContext(String configID)
        ...
        LOGD(TAG, configID!=null ? configID: "null (broker defaults)");
		...
		try {
            ...
            LOGD(TAG, keyStoreName!=null ? keyStoreName : "keyStoreName: null");

            char[] keyStorePwd=getKeyStorePassword(configID);

            LOGD(TAG, keyStorePwd!=null ? obfuscate(keyStorePwd) : "Keystore Passwd: null");
            ...
            LOGD(TAG, keyStoreType!=null ? keyStoreType : "null");
            ...
            LOGD(TAG, trustStoreName!=null ? trustStoreName : "truststorename: null");

			KeyStore trustStore=null;
			TrustManagerFactory trustMgrFact=null;
			TrustManager[] trustMgr=null;
			char[] trustStorePwd=getTrustStorePassword(configID);
            LOGD(TAG, trustStorePwd!=null ? obfuscate(trustStorePwd) : "trustStorePwd: null");
            ...
            LOGD(TAG, trustStoreType!=null ? trustStoreType : "trustStoreType: null");
			...
			if(trustStoreName!=null && trustStoreType!=null && trustMgrAlgo!=null) {
				try {
                    ...
                    LOGD(TAG, trustMgrAlgo);
                    LOGD(TAG, trustMgrFact.getProvider().getName());
	...
	public SSLSocketFactory createSocketFactory(String configID) 
        ...
        LOGD(TAG, getEnabledCipherSuites(configID)!=null ? getProperty(configID, CIPHERSUITES, null)
