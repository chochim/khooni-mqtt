...
import in.huhuba.paho.client.mqttv3.MqttMessage;
import in.huhuba.paho.client.mqttv3.MqttPersistable;
import in.huhuba.paho.client.mqttv3.MqttPersistenceException;
import in.huhuba.paho.client.mqttv3.MqttPingSender;
import in.huhuba.paho.client.mqttv3.MqttToken;
import in.huhuba.paho.client.mqttv3.internal.wire.MqttAck;
import in.huhuba.paho.client.mqttv3.internal.wire.MqttConnack;
import in.huhuba.paho.client.mqttv3.internal.wire.MqttConnect;
import in.huhuba.paho.client.mqttv3.internal.wire.MqttPingReq;
import in.huhuba.paho.client.mqttv3.internal.wire.MqttPingResp;
import in.huhuba.paho.client.mqttv3.internal.wire.MqttPubAck;
import in.huhuba.paho.client.mqttv3.internal.wire.MqttPubComp;
import in.huhuba.paho.client.mqttv3.internal.wire.MqttPubRec;
import in.huhuba.paho.client.mqttv3.internal.wire.MqttPubRel;
			...
			while (result == null) {
				...
				if ((pendingMessages.isEmpty() && pendingFlows.isEmpty()) || 
					...
					try {
                        ...
                        LOGD(TAG, methodName+" 644");
 
						queueLock.wait();
						
						//@TRACE 647=new work or ping arrived 
                        LOGD(TAG, methodName+" 647");
...
//				checkForActivity(); //Use pinger, don't check here
				...
				if (!pendingFlows.isEmpty()) {
					...
					if (actualInFlight < this.maxInflight) {
                        ...
                        LOGD(TAG, methodName+" 623");
					} else {
						//@TRACE 622=inflight window full
                        LOGD(TAG, methodName+" 622");
					}
				}			
			}
		}
